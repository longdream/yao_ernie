...
REM 验证关键依赖
echo [验证] 检查关键依赖...
python -c "from paddleocr import PaddleOCR; print('[OK] PaddleOCR')" 2>nul || (echo [ERROR] PaddleOCR未安装 & pause & exit /b 1)
...
python test_yaoscope_complete.py
